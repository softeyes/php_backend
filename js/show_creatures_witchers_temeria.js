console.log('loaded show_creatures_witchers_temeria.js');

function creatures_list() {
    console.log('Inside check_backend');
    $.get('backend/creature_type/show_creatures_from_temeria.php').done(display_creatures).fail(blow_up);
}
...
//         tr.append(td); // adds <td> to <tr>
        ...
        $('#show_creatures_witchers_temeria tbody').append(tr);
